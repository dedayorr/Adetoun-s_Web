...
const PLATFORMS = [
  {
    icon: Play,
    label: "Spotify",
    href: "https://open.spotify.com/show/048IHm26dtJt5QwI3vOxcd",
...
// https://open.spotify.com/show/048IHm26dtJt5QwI3vOxcd?si=5MnXbF0UR2COyftB68HS5A
          ...
          <div>
            ...
            <div className="border border-gold-DEFAULT/20 bg-navy-dark p-8 relative overflow-hidden mb-6">
              ...
              <div className="relative z-10 w-full">
                <iframe
                  src="https://open.spotify.com/embed/show/048IHm26dtJt5QwI3vOxcd?si=5MnXbF0UR2COyftB68HS5A"
                  width="100%"
                  height="352"
                  frameBorder="0"
          ...
          <div>
            ...
            <div className="space-y-4">
              {PLATFORMS.map(({ icon: Icon, label, href, desc, color }) => (
                ...
                >
                  <div
                    className={`w-12 h-12 ${color} flex items-center justify-center shrink-0`}
                  >
                    <Icon size={20} className="text-white" />
                  </div>
                  <div className="flex-1">
                    <p className="font-body text-white text-sm font-medium group-hover:text-gold-DEFAULT transition-colors">
                      {label}
                    </p>
                  ...
                  <ExternalLink
                    size={14}
                    className="text-white/20 group-hover:text-gold-DEFAULT transition-colors"
                  />
                </a>
              ))}
            </div>
            ...
            <div className="mt-8 border border-gold-DEFAULT/20 p-6 bg-navy-dark">
              ...
              <p className="text-white/50 text-sm font-body mb-4">
                Subscribe on your favourite platform to get notified when new
                episodes drop.
              </p>
      ...
      <SectionWrapper className="bg-navy-dark">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-display text-4xl font-light text-white mb-4">
            One Voice.{" "}
            <span className="italic text-gold-DEFAULT">One Mission.</span>
          </h2>
          <div className="divider-gold" />
          <p className="text-white/60 font-body leading-relaxed mb-4">
            The Voice of One Podcast is a teaching platform sharing messages
            designed to strengthen believers in prayer, revival, faith, and
            alignment with God's purpose.
          </p>
          <p className="text-white/60 font-body leading-relaxed">
            Each episode is crafted with intention — to ignite hunger for God,
            provide practical insight for the life of prayer, and equip
            believers to walk with fire in their generation.
          </p>
        </div>
      </SectionWrapper>
    </>
