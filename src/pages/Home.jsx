  ...
  return (
    <>
      ...
      <section className="hero-background relative min-h-screen flex items-center justify-center overflow-hidden bg-navy-dark pt-[40%] pb-[10%] md:pb-0 md:pt-[0%]">
        ...
        {/* <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold-DEFAULT/8 rounded-full blur-3xl" /> */}
        {/* <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-rust-DEFAULT/8 rounded-full blur-3xl" /> */}
        {/* <div className="absolute left-8 top-1/2 -translate-y-1/2 w-px h-48 bg-gradient-to-b from-transparent via-gold-DEFAULT to-transparent opacity-40 hidden lg:block" /> */}
        {/* <div className="absolute right-8 top-1/2 -translate-y-1/2 w-px h-48 bg-gradient-to-b from-transparent via-gold-DEFAULT to-transparent opacity-40 hidden lg:block" /> */}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/* <Link to="/media" className="inline-flex items-center gap-2 text-white/70 font-body text-sm tracking-widest uppercase hover:text-gold-DEFAULT transition-colors py-4 px-2">
              <Play size={16} /> Watch Messages
            </Link> */}
          </div>
        </div>

        {/* <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
          <span className="text-white text-xs tracking-widest font-body uppercase">Scroll</span>
      ...
      <SectionWrapper className="bg-navy">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative intercessor-div" >
            <div className="aspect-[3/4] lg:aspect-[4/3] bg-navy-light border border-white/10 relative overflow-hidden">
              {/* <div className="absolute inset-0 bg-gradient-to-br from-gold-DEFAULT/10 to-rust-DEFAULT/10" /> */}
      ...
      <SectionWrapper className="bg-navy-dark">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {MINISTRIES.map(({ icon: Icon, title, desc, to, accent }) => (
            <Link
              key={to}
              to={to}
              className="group bg-navy border border-white/10 hover:border-gold-DEFAULT/40 p-8 flex flex-col card-hover"
            >
      ...
      <SectionWrapper className="bg-navy">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          {YOUTUBE_IDS.map((id, i) => (
            <div key={i} className="aspect-video bg-navy-dark border border-white/10 overflow-hidden card-hover">
              <iframe
