    ...
    <>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="anim-fade-left">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-light text-white leading-tight mb-2">
              A Life Dedicated to{" "}
              <span className="italic text-gold-DEFAULT">God's Purposes</span>
            </h2>
            ...
            <p className="text-white/60 font-body leading-relaxed mb-6">
              ...
              whose life is dedicated to advancing God's purposes through
              prayer, discipleship, and teaching.
            </p>
            <img
              src={tounsimg1}
            ...
            <p className="text-white/60 font-body leading-relaxed mb-8">
              Her passion is to see lives transformed through the Word of God,
              to raise disciplined intercessors, and to herald a movement of
              revival marked by the power and presence of the Holy Spirit.
            </p>
            ...
            <div className="aspect-[3/4] lg:aspect-[4/3] bg-navy-light border border-white/10 relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center px-8">
                  <div className="font-display text-8xl text-gold-DEFAULT/20 font-light">
                    "
                  </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {MINISTRIES.map(({ icon: Icon, title, desc, to, accent }, i) => (
            <Link
              key={to}
              to={to}
              className={`group bg-navy border border-white/10 hover:border-gold-DEFAULT/40 p-8 flex flex-col card-hover anim-fade-up delay-${
                i + 1
              }`}
            >
              <div
                className={`w-12 h-12 ${accent} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
              >
      ...
      <SectionWrapper className="bg-navy">
        <SectionHeader
          ...
          title="Recent Teachings & Prayer Sessions"
        />
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          {YOUTUBE_IDS.map((id, i) => (
            <div
              key={i}
              className={`aspect-video bg-navy-dark border border-white/10 overflow-hidden card-hover anim-fade-up delay-${
                i + 1
              }`}
            >
              <iframe
